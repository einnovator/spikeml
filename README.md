...
A Python framework for spiking neural networks, neural dynamics, embodied cognitive modeling, and bio-inspired machine learning. 

## Features
- Spiking neuron models with stochastic and dynamical elements
